import { GROUND_Y } from "./physics.js";
  ...
  export const THEMES = {
    ...
    egypt:     { name:"Temple of Bastet" },
    china:     { name:"The Great Wall of Cathay" },
    pirate:    { name:"Purrates of the Caribbean" }
  };
  ...
  export const LEVELS = [
    ...
    // -------- WORLD 18: Temple of Bastet — mummies, quicksand, Anubis --------
    {
      name: "Temple of Bastet", theme: "egypt",
      goalX: 4260, worldW: 4400,
      platforms: [
        {x:0,    y:430, w:980,  h:170, t:"sandstone"},
        {x:1090, y:430, w:1010, h:170, t:"sandstone"},
        {x:2200, y:430, w:880,  h:170, t:"sandstone"},
        {x:3200, y:430, w:1200, h:170, t:"sandstone"},
        {x:280,  y:346, w:110, h:26, t:"pyramidstep"},
        {x:540,  y:312, w:100, h:26, t:"obelisk"},
        {x:800,  y:348, w:110, h:26, t:"sarcophagus"},
        {x:1280, y:340, w:120, h:26, t:"pyramidstep"},
        {x:1540, y:308, w:100, h:26, t:"obelisk"},
        {x:1820, y:344, w:110, h:26, t:"sarcophagus"},
        {x:2320, y:336, w:110, h:26, t:"pyramidstep"},
        {x:2580, y:302, w:100, h:26, t:"obelisk"},
        {x:2850, y:342, w:120, h:26, t:"sarcophagus"},
        {x:3340, y:344, w:110, h:26, t:"pyramidstep"},
        {x:3600, y:310, w:100, h:26, t:"obelisk"},
      ],
      collectibles: [
        {x:335,  y:310, t:"scarab"},
        {x:590,  y:276, t:"scarab"},
        {x:855,  y:312, t:"scarab"},
        {x:1340, y:304, t:"scarab"},
        {x:1590, y:272, t:"scarab"},
        {x:1875, y:308, t:"scarab"},
        {x:2375, y:300, t:"scarab"},
        {x:2630, y:266, t:"scarab"},
        {x:2910, y:306, t:"scarab"},
        {x:3395, y:308, t:"scarab"},
        {x:3650, y:274, t:"scarab"},
        {x:180,  y:398, t:"scarab"},
        {x:1200, y:398, t:"scarab"},
        {x:2280, y:398, t:"scarab"},
        {x:3300, y:398, t:"scarab"},
        {x:700,  y:398, t:"fish"},
        {x:1950, y:398, t:"fish"},
        {x:3050, y:398, t:"fish"},
        {x:960,  y:398, t:"mouse"},
      ...
      enemies: [
        {x:600,  min:430,  max:910,  vx:1.5},
        {x:1400, min:1170, max:1690, vx:1.6},
        {x:1900, min:1760, max:2060, vx:1.5},
        {x:2500, min:2270, max:2790, vx:1.7},
        {x:2950, min:2850, max:3060, vx:1.6},
        {x:3450, min:3260, max:3600, vx:1.5},
      ],
      hazards: [
        {x:980,  y:GROUND_Y+22, w:110, h:220},
        {x:2100, y:GROUND_Y+22, w:100, h:220},
        {x:3080, y:GROUND_Y+22, w:120, h:220},
      ],
      boss: { x:3830, w:112, h:96, hp:3, vx:1.9, min:3490, max:4020, name:"Anubis" }
    },
    // -------- WORLD 19: The Great Wall of Cathay — warriors, spikes, a jade dragon --------
    {
      name: "The Great Wall of Cathay", theme: "china",
      goalX: 4260, worldW: 4400,
      platforms: [
        {x:0,    y:430, w:1020, h:170, t:"greatwall"},
        {x:1130, y:430, w:960,  h:170, t:"greatwall"},
        {x:2210, y:430, w:920,  h:170, t:"greatwall"},
        {x:3250, y:430, w:1150, h:170, t:"greatwall"},
        {x:300,  y:344, w:110, h:26, t:"pagodaroof"},
        {x:560,  y:310, w:100, h:26, t:"bamboo"},
        {x:830,  y:346, w:110, h:26, t:"jadeblock"},
        {x:1320, y:338, w:120, h:26, t:"pagodaroof"},
        {x:1580, y:306, w:100, h:26, t:"bamboo"},
        {x:1850, y:342, w:110, h:26, t:"jadeblock"},
        {x:2360, y:334, w:110, h:26, t:"pagodaroof"},
        {x:2620, y:300, w:100, h:26, t:"bamboo"},
        {x:2890, y:340, w:120, h:26, t:"jadeblock"},
        {x:3380, y:342, w:110, h:26, t:"pagodaroof"},
        {x:3640, y:308, w:100, h:26, t:"bamboo"},
      ],
      collectibles: [
        {x:355,  y:308, t:"luckycoin"},
        {x:610,  y:274, t:"luckycoin"},
        {x:885,  y:310, t:"luckycoin"},
        {x:1380, y:302, t:"luckycoin"},
        {x:1630, y:270, t:"luckycoin"},
        {x:1905, y:306, t:"luckycoin"},
        {x:2415, y:298, t:"luckycoin"},
        {x:2670, y:264, t:"luckycoin"},
        {x:2950, y:304, t:"luckycoin"},
        {x:3435, y:306, t:"luckycoin"},
        {x:3690, y:272, t:"luckycoin"},
        {x:190,  y:398, t:"luckycoin"},
        {x:1240, y:398, t:"luckycoin"},
        {x:2300, y:398, t:"luckycoin"},
        {x:3340, y:398, t:"luckycoin"},
        {x:720,  y:398, t:"fish"},
        {x:1960, y:398, t:"fish"},
        {x:3080, y:398, t:"fish"},
        {x:970,  y:398, t:"mouse"},
        {x:2060, y:398, t:"mouse"},
        {x:2790, y:398, t:"mouse"},
        {x:3820, y:398, t:"mouse"},
      ],
      enemies: [
        {x:620,  min:440,  max:940,  vx:1.5},
        {x:1420, min:1210, max:1720, vx:1.6},
        {x:1920, min:1790, max:2060, vx:1.5},
        {x:2520, min:2290, max:2820, vx:1.7},
        {x:2980, min:2880, max:3100, vx:1.6},
        {x:3480, min:3300, max:3640, vx:1.5},
      ],
      hazards: [
        {x:1020, y:GROUND_Y+22, w:110, h:220},
        {x:2090, y:GROUND_Y+22, w:120, h:220},
        {x:3130, y:GROUND_Y+22, w:120, h:220},
      ],
      boss: { x:3830, w:130, h:88, hp:3, vx:2.1, min:3500, max:4020, name:"Jade Dragon" }
    },
    // -------- WORLD 20: Purrates of the Caribbean — skeleton crew, sharks, the Captain --------
    {
      name: "Purrates of the Caribbean", theme: "pirate",
      goalX: 4260, worldW: 4400,
      platforms: [
        {x:0,    y:430, w:1000, h:170, t:"shipdeck"},
        {x:1120, y:430, w:980,  h:170, t:"shipdeck"},
        {x:2200, y:430, w:900,  h:170, t:"shipdeck"},
        {x:3220, y:430, w:1180, h:170, t:"shipdeck"},
        {x:290,  y:346, w:110, h:26, t:"barrel"},
        {x:550,  y:312, w:100, h:26, t:"plank"},
        {x:820,  y:348, w:110, h:26, t:"cannon"},
        {x:1300, y:340, w:120, h:26, t:"barrel"},
        {x:1560, y:308, w:100, h:26, t:"plank"},
        {x:1840, y:344, w:110, h:26, t:"cannon"},
        {x:2340, y:336, w:110, h:26, t:"barrel"},
        {x:2600, y:302, w:100, h:26, t:"plank"},
        {x:2870, y:342, w:120, h:26, t:"cannon"},
        {x:3360, y:344, w:110, h:26, t:"barrel"},
        {x:3620, y:310, w:100, h:26, t:"plank"},
      ],
      collectibles: [
        {x:345,  y:310, t:"doubloon"},
        {x:600,  y:276, t:"doubloon"},
        {x:875,  y:312, t:"doubloon"},
        {x:1360, y:304, t:"doubloon"},
        {x:1610, y:272, t:"doubloon"},
        {x:1895, y:308, t:"doubloon"},
        {x:2395, y:300, t:"doubloon"},
        {x:2650, y:266, t:"doubloon"},
        {x:2930, y:306, t:"doubloon"},
        {x:3415, y:308, t:"doubloon"},
        {x:3670, y:274, t:"doubloon"},
        {x:185,  y:398, t:"doubloon"},
        {x:1230, y:398, t:"doubloon"},
        {x:2290, y:398, t:"doubloon"},
        {x:3320, y:398, t:"doubloon"},
        {x:710,  y:398, t:"fish"},
        {x:1950, y:398, t:"fish"},
        {x:3060, y:398, t:"fish"},
        {x:965,  y:398, t:"mouse"},
        {x:2055, y:398, t:"mouse"},
        {x:2770, y:398, t:"mouse"},
        {x:3810, y:398, t:"mouse"},
      ],
      enemies: [
        {x:610,  min:440,  max:920,  vx:1.6},
        {x:1410, min:1200, max:1700, vx:1.7},
        {x:1910, min:1770, max:2050, vx:1.6},
        {x:2510, min:2280, max:2800, vx:1.8},
        {x:2960, min:2860, max:3070, vx:1.7},
        {x:3460, min:3280, max:3610, vx:1.6},
      ],
      hazards: [
        {x:1000, y:GROUND_Y+22, w:120, h:220},
        {x:2100, y:GROUND_Y+22, w:100, h:220},
        {x:3100, y:GROUND_Y+22, w:120, h:220},
      ],
      boss: { x:3830, w:114, h:94, hp:3, vx:2.0, min:3500, max:4020, name:"Captain Blackpaw" }
    }
  ];
